        ...
        return (
            <div className='detailsCountry'>
                ...
                <form className="detailsCountry__form">
                    <input className='detailsCountry__input' type="text" onChange={(event) => this.props.onChangeInput(event)} value={this.props.valueInput} placeholder="Type few letter's of country" />
                </form>
                {eachCountry}
            </div>
        )
